...
public class DBGetter {
    public DBDump dumpDB() {
        ...
        var harbours = new Harbour[]{
                new Harbour(0, "New York", new Point(0, 0)),
                new Harbour(1, "Boston", new Point(1, 1)),
                new Harbour(2, "Tallinn", new Point(2, 3))
        };

        var cargos = new Cargo[]{
                new Cargo(harbours[0], harbours[1], 0, 10),
                new Cargo(harbours[2], harbours[0], 1, 100),
        };
